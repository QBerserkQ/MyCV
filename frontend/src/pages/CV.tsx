...
import {
    ArrowLeft, ArrowRight, Award, BookOpen, BriefcaseBusiness, ChevronRight, Code2, Database, Download, ExternalLink, Globe2,
    Mail, MapPin, Menu, Shield, Sparkles, Terminal, Trophy,
} from "lucide-react";

import {SiGithub, SiLeetcode, SiTelegram} from "@icons-pack/react-simple-icons";
                ...
                <div className="grid gap-5 lg:grid-cols-[280px_1fr]">
                    <Panel className="flex flex-col p-5 sm:p-6 lg:sticky lg:top-8 lg:h-fit">
                        <div className="portrait-frame mb-6">
                            <div className="flex h-full items-center justify-center bg-[radial-gradient(circle_at_50%_35%,#52718b_0,#1d2a35_32%,#0b1118_72%)]">
                                <div className="relative mt-5 text-center">
                                    ...
                                    <span className="absolute inset-0 flex items-center justify-center pt-4 font-serif text-5xl text-sky-200/80">
                                        AK
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="mt-6 flex items-center justify-between">
                            <span className="flex items-center gap-2 text-[10px] uppercase tracking-widest text-emerald-300"><span className="h-2 w-2 animate-pulse rounded-full bg-emerald-300" />
                                Open to quests
                            </span>
                            <button onClick={() => window.print()} className="text-slate-500 transition hover:text-sky-300" title="Print CV"><Download className="h-4 w-4" />
                            </button>
                        </div>
                    </Panel>
